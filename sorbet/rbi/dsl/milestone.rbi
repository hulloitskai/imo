...
class Milestone
  ...
  module GeneratedAssociationMethods
    sig { params(args: T.untyped, blk: T.untyped).returns(::Quest) }
    def build_quest(*args, &blk); end

    sig { params(args: T.untyped, blk: T.untyped).returns(::Quest) }
    def create_quest(*args, &blk); end
    ...
    sig { params(value: T.nilable(::Quest)).void }
    def quest=(value); end

    sig { returns(T::Boolean) }
    def quest_changed?; end

    sig { returns(T::Boolean) }
    def quest_previously_changed?; end

    sig { returns(T.nilable(::Quest)) }
    def reload_quest; end
